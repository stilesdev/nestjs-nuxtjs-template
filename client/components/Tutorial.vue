...
<template>
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <a class="flex justify-center pt-8 sm:pt-0" href="https://nestjs.com" target="_blank">
                <NestLogo></NestLogo>
            </a>
            <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
                <h2 class="text-2xl leading-7 font-semibold">Welcome to your Nuxt + Nest Application!</h2>
                <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
                    <strong>Sample API response from NestJS backend:</strong> <code class="bg-gray-100 text-sm p-1 rounded border">{{ apiText }}</code>
                </p>
            </div>
        </div>
    </div>
